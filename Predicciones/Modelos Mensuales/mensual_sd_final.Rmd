...
Comparando las métricas consideradas tanto para el entrenamiento como la validación del árbol optimo, observamos que en ambas se obtuvo buenos R-squared, superiores al 90%. La variación entre los RMSE es del 8%, esta variación es baja y nos indica mejor ajuste en comparación con el modelo de regresión lineal.
...
Inicialmente, observamos que la varianza explicada por el modelo es del 83,9 %.
...
```{r}
set.seed(101)
mejorRandomforest <- randomForest(SOLO_DANOS.R ~., data = soloD_train, mtry = 3, nodesize = 7, ntree = 500, sampe_size= 0.8, importance = TRUE)
